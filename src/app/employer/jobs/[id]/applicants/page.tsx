...
export default async function JobApplicantsPage({
  ...
  rows.sort((x, y) => {
    if (sort === "experience")
      return (y.a.jobSeeker.experience_years ?? 0) - (x.a.jobSeeker.experience_years ?? 0);
    if (sort === "date")
      return y.a.applied_at.getTime() - x.a.applied_at.getTime();
  ...
  return (
    <div className="space-y-4">
      ...
      <form>
        ...
        <button className="ml-2 rounded-lg border border-line px-3 py-2 text-sm">
          Sort
        </button>
      </form>
          ...
          <Card key={a.application_id} className="space-y-3">
            <div className="flex flex-wrap justify-between gap-3">
              <div>
                ...
                <p className="text-sm">
                  {a.jobSeeker.experience_years ?? 0} years experience
                </p>
              </div>
            ...
            {resume ? (
              <a
                ...
                className="inline-flex items-center rounded-lg bg-blue-50 px-3 py-1.5 text-sm font-medium text-blue-700 hover:bg-blue-100 transition"
              >
